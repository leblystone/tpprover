...
/**
 * Builds a personalised weekly analytics summary from a user's userData doc.
 * Returns completion counts for this week vs last week, active protocol names,
 * and any low-stock items so the email shows real insights instead of generic tips.
 */
  ...
  async (event) => {
    ...
    try {
      ...
      for (const userDoc of usersSnapshot.docs) {
        ...
        let summary = { hasData: false, activeProtocols: [], lowStockCount: 0, lowStockItems: [], thisWeekTotal: 0, lastWeekTotal: 0, thisWeekDays: 0, lastWeekDays: 0, delta: 0, daysDelta: 0 };
        try {
