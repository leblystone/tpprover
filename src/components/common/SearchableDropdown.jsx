    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <input
                ref={inputRef}
                type="text"
                className="w-full text-left px-2.5 py-2 rounded-lg text-xs focus:ring-0 outline-none"
                style={{ 
                    backgroundColor: theme.isDark ? 'rgba(255,255,255,0.04)' : (theme.inputBackground || '#fff'),
                    color: theme.text,
                    border: `1px solid ${theme.border || (theme.isDark ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)')}`,
