...
/**
 * SubscriptionGuard - Redirects expired trials to trial-expired page or ended subscriptions to subscription-expired page
...
export default function SubscriptionGuard({ children }) {
  ...
  if (!hasAccess && !isAllowedRoute) {
    // Redirect to appropriate page based on whether subscription ended or trial expired
