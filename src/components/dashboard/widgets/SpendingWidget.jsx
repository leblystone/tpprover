    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 p-4 pb-5 flex flex-col justify-center">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center p-2 rounded" style={{ backgroundColor: theme.isDark ? 'rgba(255,255,255,0.04)' : theme.secondary }}>
          ...
          <button
            type="button"
            onClick={() => setShowBreakdownModal(true)}
            className="text-xs mt-2 py-1 rounded text-center w-full transition-opacity"
