...
export const TermsOfServiceContent = () => (
    <div className="space-y-4 text-sm text-gray-600">
        ...
        <div>
            ...
            <p className="mt-3"><strong>Cancellation Policy (incorporated by reference):</strong> By subscribing or purchasing, you agree to our Cancellation Policy. In summary: you may cancel your subscription at any time through your Account or by contacting us at contact@thepepplanner.com; cancellation takes effect at the end of your current billing period and you retain access until then; we do not automatically delete your account or data—deletion only occurs if you request it; we do not provide refunds for unused portions of subscription periods except as required by law; refunds for Apple App Store and Google Play purchases are handled by Apple and Google per their policies. The full Cancellation Policy is part of these Terms and available in the app and on our website.</p>
        </div>
