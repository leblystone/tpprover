        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[10000]">
            <div className="bg-white rounded-xl shadow-2xl p-8 max-w-lg w-full m-4 text-center border animate-fade-in" style={{ borderColor: theme.border }}>
                ...
                <p className="text-gray-600 mb-6">
                    Thank you for joining our beta testing! The app will remain open for you from <b>September 10th - September 17th</b>. Feedback will be requested at the end of your trial testing. Once again, I appreciate your time! I hope you enjoy The Pep Planner.✌️
                </p>
