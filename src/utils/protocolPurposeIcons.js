...
export const PURPOSE_ICON_OPTIONS = [
    ...
    { id: 'recovery', label: 'Recovery', keywords: ['recover', 'heal', 'repair', 'injury', 'rehab'], Icon: Pulse },
...
export function ProtocolPurposeGlyph({ protocol, size = 18, weight = PURPOSE_ICON_WEIGHT, className, style, ...rest }) {
